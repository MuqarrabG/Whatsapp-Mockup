  ...
  const userChats = [
    {
      ...
      user: {
        name: "Alice",
        avatar:
          "https://robohash.org/sapientemolestiaeneque.png?size=300x300&set=set1",
      },
      lastMessage: { sender: "You", message: "See you soon!" },
    ...
    },
    {
      ...
      lastMessage: { sender: "Alice", message: "Where are you?" },
